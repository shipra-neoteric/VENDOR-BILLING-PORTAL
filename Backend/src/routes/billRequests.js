...
const { getPendingBillsSummary } = require('../controllers/billController');

router.use(authenticate);

// Read-only rollup (BillRequests + manual RunningBills currently pending
// approval) for the Daily Progress Report page's "Pending Bills" section —
// registered ahead of '/' so it can't be swallowed by any future param route.
router.get('/pending-summary',  getPendingBillsSummary);
