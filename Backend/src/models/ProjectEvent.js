...
const EVENT_TYPES = [
  ...
  'WORK_ORDER_SUBMITTED', 'WORK_ORDER_CHECKER_APPROVED', 'WORK_ORDER_APPROVER_APPROVED',
  'WORK_ORDER_FINAL_APPROVED', 'WORK_ORDER_SENT_BACK',
  'PROGRESS_ADDED',
  'BILL_REQUESTED', 'BILL_REQUEST_AGM_APPROVED', 'BILL_REQUEST_APPROVED', 'BILL_REQUEST_REJECTED',
  'RUNNING_BILL_CREATED', 'RUNNING_BILL_SUBMITTED', 'RUNNING_BILL_MAKER_CONFIRMED',
