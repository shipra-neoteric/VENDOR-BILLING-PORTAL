...
const S = StyleSheet.create({
  page: { padding: 36, fontSize: 8.5, fontFamily: "Hind", color: DARK, backgroundColor: "#fff" },
  ...
  logoName:  { fontSize: 16, fontWeight: "bold", color: DARK, letterSpacing: 0.5 },
  logoSub:   { fontSize: 8, color: GRAY, marginTop: 2, letterSpacing: 0.3 },
  docTitle:  { textAlign: "right" },
  docMain:   { fontSize: 14, fontWeight: "bold", color: ORANGE, letterSpacing: 0.4 },
  docSub:    { fontSize: 9, fontWeight: "bold", color: MID, marginTop: 3, letterSpacing: 0.3 },
  ...
  secTitle:  { fontWeight: "bold", color: "#fff", fontSize: 8, letterSpacing: 0.4 },
  row:       { flexDirection: "row", borderTopWidth: 1, borderTopColor: BORDER },
  rowLast:   { flexDirection: "row" },
  cellLabel: { width: "38%", backgroundColor: LIGHT, padding: "5px 10px", fontWeight: "bold", fontSize: 8, color: MID },
  cellVal:   { flex: 1, padding: "5px 10px", fontSize: 8, color: DARK },
  cellValMono: { flex: 1, padding: "5px 10px", fontSize: 8, color: DARK },
  ...
  hdrText:   { color: "#fff", fontWeight: "bold", fontSize: 7.5 },
  ...
  msPay:     { width: 62, fontSize: 7.5, textAlign: "right", fontWeight: "bold" },

  warrRow:   { flexDirection: "row", marginBottom: 3.5, gap: 4 },
  warrNum:   { fontSize: 7, color: ORANGE, fontWeight: "bold", width: 12 },
  ...
  totalLabel:{ fontWeight: "bold", fontSize: 8.5, color: ORANGE, marginRight: 10, width: 90, textAlign: "right" },
  totalVal:  { fontWeight: "bold", fontSize: 8.5, color: DARK, width: 68, textAlign: "right" },
  gstRow:    { flexDirection: "row", justifyContent: "flex-end", borderTopWidth: 1, borderTopColor: BORDER, padding: "4px 8px" },
  gstLabel:  { fontSize: 7.5, color: GRAY, marginRight: 10, width: 90, textAlign: "right" },
  gstVal:    { fontSize: 7.5, color: GRAY, width: 68, textAlign: "right" },

  termsHdr:  { fontWeight: "bold", fontSize: 8, color: DARK, marginBottom: 5, borderLeftWidth: 3, borderLeftColor: ORANGE, paddingLeft: 6, letterSpacing: 0.3 },
  termRow:   { flexDirection: "row", marginBottom: 3.5, gap: 4 },
  termNum:   { fontSize: 7, color: ORANGE, fontWeight: "bold", width: 14, paddingTop: 0.5 },
  termText:  { flex: 1, fontSize: 7, color: MID, lineHeight: 1.6 },
  ...
  sigRole:   { fontSize: 7.5, fontWeight: "bold", color: MID, marginBottom: 22, letterSpacing: 0.3 },
