          ...
          <div className="space-y-5">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
              ...
              {customItems.length > 0 && (
                // Styled to match the scope-items Table above (same border/
                // rounded wrapper, gray header band, row dividers) — but NOT
                // the actual <Table> component, since its wrapper div is
                // overflow-x-auto, which clips the Unit dropdown's popup menu
                // (overflow-x non-visible implicitly computes overflow-y:
                // auto too, per the CSS Overflow spec).
                <div className="rounded-lg border border-gray-200 overflow-visible">
                  <div className="grid grid-cols-[2fr_1fr_0.8fr_0.9fr_0.9fr_44px] gap-2 px-4 py-3 bg-gray-50 text-[11px] font-bold text-gray-500 uppercase tracking-wider rounded-t-lg">
