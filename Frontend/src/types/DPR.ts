...
export interface DPRSiteProgressRow {
  projectId: string; projectName: string; workOrderNo: string;
...
export interface DPRAgingRow { contractor: string; project: string; billNo: string; amount: number; daysPending: number; status: string; }
export interface DPRAgingHeatCell { projectId: string; projectName: string; bucket: string; count: number; }

export interface DPRDelayedContractor { vendorName: string; pendingAmount: number; daysWaiting: number; billCount: number; }
export interface DPRDelayedProject { projectId: string; projectName: string; pendingAmount: number; avgDelayDays: number; }
export interface DPRAdvancePayment { vendorName: string; projectName: string; amount: number; reason: string; adjusted: number; balance: number; date: string; }
...
export interface DPRReport {
  meta: { date: string; projectId: string | null; generatedAt: string };
